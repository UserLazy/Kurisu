...
LOGGER.info("[ODA] Oda is starting. | An Gabut User Project. | Licensed under GPLv3.")

LOGGER.info("[ODA] Not affiliated to Shie Hashaikai or Villain in any way whatsoever.")
LOGGER.info("[ODA] Project maintained by: github.com/Scroxy-X (t.me/RxyMX)")
